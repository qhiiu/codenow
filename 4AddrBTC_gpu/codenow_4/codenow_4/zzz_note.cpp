// thêm class hiiu_Bitcoin trong file SECP256K1

// chỉnh addr tại // codenow-here  dòng 294 trong KeyHunt.cpp
...
class hiiu_Bitcoin 
{
	public:
		...
		std::string hash160ToAddr(int type, uint8_t* _hash160, bool isCompressed); //return STRING 
};  
//-------------------------------------------------------------------- 
...
std::string hiiu_Bitcoin::hash160ToAddr(int type, uint8_t* _hash160, bool isCompressed){
