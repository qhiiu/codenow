...
Point hiiu_Bitcoin::privToPubkey(char* p_hex)
{
	char* priv_hex = p_hex;
...
//--------------------------------------------------------------------
 void hiiu_Bitcoin::privToHash160(int type, char* p_hex, uint32_t* _hash160, bool isCompressed)
 {
...
std::string hiiu_Bitcoin::privToAddr(int type, char* p_hex, bool isCompressed)
{
	char* priv_hex = p_hex;   // char* priv_hex = "2832ed74f2b5e35ee"; 
...
//--------------------------------------------------------------------
void hiiu_Bitcoin::pubkeyToHash160(int type, Point& pubKey, uint32_t* _hash160,  bool isCompressed)
{
	Secp256K1* hiiu_secp = new Secp256K1();   
	hiiu_secp->Init();	
...
//--------------------------------------------------------------------
std::string hiiu_Bitcoin::pubkeyToAddr(int type, Point& pubKey, bool isCompressed)
{
	Secp256K1*	hiiu_secp = new Secp256K1();   
	hiiu_secp->Init();	
...
std::string hiiu_Bitcoin::hash160ToAddr(int type, uint32_t* _hash160, bool isCompressed){
